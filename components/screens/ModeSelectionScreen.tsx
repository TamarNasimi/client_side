...
//   //בדיקות שהמשתמש השלים את כל השדות חובה
//   const validateForm = () => {
...
//     }
//     else{
//       axios.post('http://localhost:3000/DataTrip/', { statusTrip: tripPurpose })
...
//   const handleSubmit = () => {
//     if (validateForm()) {
//       console.log('Form submitted with data:', { tripPurpose, startingPoint, destination, stopPoints, maxSlope, healthHighlights, calories });
...
//   button: {
//     marginTop: 16,
//    // backgroundColor: 'blue', // Change to light blue color
//   },
//   label: {
//     marginRight: 16,
//   },
...
//   addButton: {
//     marginTop: 16,
//     marginBottom: 32, // Increase the margin bottom for more space
